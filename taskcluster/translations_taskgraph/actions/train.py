...
(any stages this choice depends on will be automatically included).""",
                ...
                "enum": ["clean-corpus", "clean-mono", "bicleaner", "bicleaner-ai", "merge-corpus", "merge-devset", "train-vocab", "train-backwards", "evaluate-backwards", "train-teacher", "evaluate-teacher", "finetune-teacher", "evaluate-finetuned-teacher", "evaluate-teacher-ensemble"],
            },
            "experiment": {
                "type": "object",
                ...
                "properties": {
                    ...
                    "mono-max-sentences-src": {
                        "type": "number",
                        "description": "src language max sentence",
                    },
                    "mono-max-sentences-trg": {
                        "type": "number",
                        "description": "trg language max sentence",
                    },
                    "split-length": {
                        "type": "number",
                        "description": "???",
